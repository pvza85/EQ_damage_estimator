...
def automatic_crop(file_name, window_size, stepSize, output_folder='', output_file_name='', extract_to_txt=True):
    ...
    if if_geotiff(file_name):
        ...
        if_geo = False
    #print if_geo
    for (x, y, window) in sliding_window(image, stepSize=stepSize, windowSize=(window_size, window_size)):
        i = i + 1
